...
The plugin stores one administrator-configurable diagnostics option and two internal options in version 0.1.8. No option grants remote-action capability.
